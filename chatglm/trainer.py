...
class Trainer:
    ...
    def __init__(
        ...
        save_peft_params_only = False,
    ):
        self.save_peft_params_only = save_peft_params_only or save_prefixencoder
        if args is None:
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        ...
        if not isinstance(self.model, PreTrainedModel):
            ...
            if self.save_peft_params_only:
                print("Saving PEFT parameters")
                state_dict = self.model.state_dict()
                filtered_state_dict = {}
